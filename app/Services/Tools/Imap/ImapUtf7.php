...
class ImapUtf7
{
    ...
    private static function encodeB64Imap(string $s): string
    {
        $a = 0;
        $al = 0;
        $res = '';
    ...
    private static function encodeUtf8Char(int $w): string
    {
        if ($w & 0x80000000) {
            return '';
        }
    ...
    private static function decodeB64Imap(string $s): string
    {
        $a = 0;
        $al = 0;
        $res = '';
